...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['codigo']) && isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['tipoContrato']) &&isset($_POST['sueldo'])) {
    ...
    if(isset($_POST['guardar'])) {
        ...
        if ($listaEmpleados->consultarEmpleado($codigo) !== null) {
            ...
            $empleado_guardar = $listaEmpleados->agregarEmpleado($codigo, $nombre, $apellido, $tipoContrato, $sueldo);
        ...
        $resultado_actualizacion = $listaEmpleados->actualizarEmpleado($codigo_actualizar, $nombre_actualizar, $apellido_actualizar, $tipoContrato_actualizar, $sueldo_actualizar);
